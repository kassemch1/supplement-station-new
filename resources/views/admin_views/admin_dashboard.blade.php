                ...
                <form id="companyInfoForm" method="post" action="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-30">
                            ...
                            <input name="phone" class="form-control" type="text"  placeholder="Phone Number" value="">
                        </div>
{{--                        @if($company->location)--}}
{{--                            <div class="col-12 mb-30">--}}
{{--                                <label for="">Location</label>--}}
{{--                                <textarea name="location" class="form-control">{{$company->location}}</textarea>--}}
{{--                            </div>--}}
{{--                        @else--}}
{{--                            <div class="col-12 mb-30">--}}
{{--                                <label for="">Location</label>--}}
...
{{--                        @endif--}}
                        ...
                        <div class="col-12 mb-30">
                            <label for="">What people say</label>
                            <textarea name="what_people_say" class="form-control"></textarea>
                        </div>

                        <div class="col-12 mb-30">
                            <label for="">Why choose us</label>
                            <textarea name="why_choose_us" class="form-control"></textarea>
                        </div>
