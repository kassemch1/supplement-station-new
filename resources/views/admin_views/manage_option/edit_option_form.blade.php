    ...
    <div class="content-body">
        ...
        <div class="add-edit-product-wrap col-12">
            <div class="add-edit-product-form">
                <form id="optionEditForm" method="post" action="{{ route('manageOptions.update') }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12 mb-30">
                            ...
                            <input name="option_name" class="form-control" type="text" placeholder="Option Name" value="{{ $option->option_name }}">
                        </div>
                    </div>
                    <!-- Success Alert -->
                    <div id="successAlert" class="alert alert-success mt-3" style="display: none;">
                        <strong>Success!</strong> Option updated successfully.
                    </div>
                    <!-- Error Alert -->
                    <div id="errorAlert" class="alert alert-danger mt-3" style="display: none;">
                        <strong>Error!</strong> Failed to update option. Please try again.
                    </div>
                    <!-- Button Group Start -->
                    <div class="row">
...
<script>
    $(document).ready(function() {
        $('#optionEditForm').submit(function(e) {
