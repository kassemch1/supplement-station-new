                ...
                <div class="xb-item--holder">
                    ...
                    <div class="xb-item--rating-inner ul_li_center">
                        <ul class="xb-item--rating ul_li">
                            <li><img src="{{ asset('assets/img/icon/star.png') }}"
                                     alt="Star"></li>
                            <li><img src="{{ asset('assets/img/icon/star.png') }}"
                                     alt="Star"></li>
                            <li><img src="{{ asset('assets/img/icon/star.png') }}"
                ...
                <div class="xb-item--action ul_li mt-20"
                     style="position: absolute; bottom: 30px; width: 80%;">
                                                <span class="xb-item--price">
                                                    @if($item->discount > 0)
                                                        <span
                                                            style="text-decoration: line-through; color: gray;">${{ number_format($item->price, 2) }}</span>
                                                        <span
                                                            style="color: #A02334;">${{ number_format($item->price - ($item->price * $item->discount / 100), 2) }}</span>
                                                    @else
                    ...
                    @if($item->stock > 0)
                        <a href="{{ route('products.show', $item->id) }}"
                           class="xb-item--cart-btn">
                                                            <span class="xb-item--cart-icon"><img
                                                                    src="{{ asset('assets/img/icon/bag.svg') }}"
                                                                    alt="Cart"></span>
